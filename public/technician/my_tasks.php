...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
        ...
        <a href="all_requests.php" class="btn btn-outline-success btn-sm">
            <i class="fas fa-hand-paper"></i> Claim Requests
        </a>
    </div>
        ...
        <div class="card-body py-2">
            <div class="d-flex flex-wrap align-items-center gap-2">
                ...
                <div class="search-box">
                    ...
                    <input type="text" id="searchInput" placeholder="Search by asset..." 
    ...
    <!-- Tasks Table - Issue column removed -->
    <div class="card">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button class="btn btn-sm btn-outline-primary btn-action" 
                                                ...
                                                data-asset="<?php echo htmlspecialchars($task['asset_name'] ?? 'N/A'); ?>"
                                                data-asset-tag="<?php echo htmlspecialchars($task['asset_tag'] ?? ''); ?>"
                                                data-reported-by="<?php echo htmlspecialchars($task['reported_by_name'] ?? 'Unknown'); ?>"
                                                data-priority="<?php echo $task['priority']; ?>"
                                                data-status="<?php echo $task['status']; ?>"
                                                data-description="<?php echo htmlspecialchars($task['issue_description']); ?>"
                            ...
                            <tr>
                                <td colspan="7">
                                    <div class="no-results">
                                        ...
                                        <a href="all_requests.php" class="btn btn-success btn-sm mt-2">
                                            <i class="fas fa-hand-paper"></i> Claim Requests
                                        </a>
                                    </div>
                                </td>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php if ($detail_request && $detail_request['resolution_notes']): ?>
                <div class="row">
                    <div class="col-12">
...
<script>
    ...
    document.querySelectorAll('[data-bs-target="#viewModal"]').forEach(button => {
        button.addEventListener('click', function() {
            ...
            // Assigned To (get from detail_request if available)
            <?php if ($detail_request): ?>
                document.getElementById('viewLocation').textContent = '<?php echo htmlspecialchars($detail_request['location'] ?? 'N/A'); ?>';
                document.getElementById('viewAssignedTo').textContent = '<?php echo htmlspecialchars($detail_request['assigned_tech_name'] ?? 'Not assigned'); ?>';
            <?php else: ?>
                document.getElementById('viewLocation').textContent = 'N/A';
                document.getElementById('viewAssignedTo').textContent = 'You';
            <?php endif; ?>
        });
    });

    console.log('✅ Technician My Tasks Loaded');
</script>
