    ...
    <div class="sidebar-nav">
        ...
        if ($role === 'System Administrator') {
            $nav_items = [
                ...
                ['url' => '../admin/users.php', 'icon' => 'fa-users', 'label' => 'Manage Users'],
            ...
            $nav_items = [
                ...
                ['url' => '../technician/all_requests.php', 'icon' => 'fa-clipboard-list', 'label' => 'All Tasks'],
                ['url' => '../technician/my_tasks.php', 'icon' => 'fa-tasks', 'label' => 'My Tasks'],
                ['url' => '../technician/assets.php', 'icon' => 'fa-laptop', 'label' => 'Assets'],
                ['url' => '../technician/printer_status.php', 'icon' => 'fa-print', 'label' => 'Printer Status'],
            ...
            $nav_items = [
                ...
                ['url' => '../staff/printer_status.php', 'icon' => 'fa-print', 'label' => 'Printer Status']
...
<!-- ====== INCLUDE ICT ASSISTANCE BOT ====== -->
<?php include __DIR__ . '/ict_bot.php'; ?>
