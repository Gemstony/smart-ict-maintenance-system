...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
        ...
        <div class="d-flex gap-2">
            <a href="print_labels.php?status=<?php echo urlencode($filter_status); ?>&category=<?php echo urlencode($filter_category); ?>&search=<?php echo urlencode($search); ?>"
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button class="btn btn-sm btn-primary btn-action" data-bs-toggle="modal"
                                            data-bs-target="#editAssetModal" data-asset-id="<?php echo $asset['asset_id']; ?>"
                                            data-asset-tag="<?php echo htmlspecialchars($asset['asset_tag']); ?>"
                                            ...
                                            data-location="<?php echo htmlspecialchars($asset['location'] ?? ''); ?>"
                                            data-purchase="<?php echo $asset['purchase_date'] ?? ''; ?>"
                                            data-warranty="<?php echo $asset['warranty_expiry'] ?? ''; ?>"
                                            data-status="<?php echo $asset['status']; ?>"
                                            data-assigned="<?php echo $asset['assigned_to'] ?? ''; ?>"
                                            data-last-maintenance="<?php echo $asset['last_maintenance_date'] ?? ''; ?>"
                                            data-next-maintenance="<?php echo $asset['next_maintenance_date'] ?? ''; ?>"
                                            title="Edit Asset">
                                        ...
                                        <button class="btn btn-sm btn-warning btn-action"
                                            onclick="showConfirm('toggle_status', '<?php echo htmlspecialchars($asset['name']); ?>', <?php echo $asset['asset_id']; ?>)"
                                            title="Change Status">
                                        ...
                                        <button class="btn btn-sm btn-info btn-action"
                                            onclick="showConfirm('generate_qr', '<?php echo htmlspecialchars($asset['name']); ?>', <?php echo $asset['asset_id']; ?>)"
